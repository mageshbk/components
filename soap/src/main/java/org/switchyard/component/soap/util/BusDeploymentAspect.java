...
public final class BusDeploymentAspect extends AbstractDeploymentAspect
{
   ...
   public BusDeploymentAspect(String configName, String configFile) {
   ...
   private void startDeploymentBus(final Deployment dep)
   {
      ...
      try
      {
         ...
         Configurer configurer = createServerConfigurer(dep.getAttachment(BindingCustomization.class),
         ...
         List<Endpoint> depEndpoints, UnifiedVirtualFile root)
   {
      ...
      customizer.setConfigName(configName);
      customizer.setConfigFile(configFile);
