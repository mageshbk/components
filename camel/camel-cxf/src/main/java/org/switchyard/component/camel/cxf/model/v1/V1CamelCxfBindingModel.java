...
/**
 * V1Camel CXF binding model.
 */
public class V1CamelCxfBindingModel extends V1BaseCamelBindingModel
     ...
     */
    public V1CamelCxfBindingModel(String namespace) {
        super(CXF, namespace);
     ...
     */
    public V1CamelCxfBindingModel(Configuration config, Descriptor desc) {
        super(config, desc);
    }
    ...
    @Override
    public V1CamelCxfBindingModel setCxfURI(URI cxfURI) {
    ...
    @Override
    public V1CamelCxfBindingModel setWsdlURL(String wsdlURL) {
    ...
    @Override
    public V1CamelCxfBindingModel setServiceClass(String serviceClass) {
    ...
    @Override
    public V1CamelCxfBindingModel setServiceName(String serviceName) {
    ...
    @Override
    public V1CamelCxfBindingModel setPortName(String portName) {
    ...
    @Override
    public V1CamelCxfBindingModel setDataFormat(String dataFormat) {
    ...
    @Override
    public V1CamelCxfBindingModel setRelayHeaders(Boolean relayHeaders) {
    ...
    @Override
    public V1CamelCxfBindingModel setWrapped(Boolean wrapped) {
    ...
    @Override
    public V1CamelCxfBindingModel setWrappedStyle(Boolean wrappedStyle) {
    ...
    @Override
    public V1CamelCxfBindingModel setSetDefaultBus(Boolean setDefaultBus) {
    ...
    @Override
    public V1CamelCxfBindingModel setBus(String bus) {
        setConfig(BUS, bus);
        return this;
    }
    ...
    @Override
    public V1CamelCxfBindingModel setCxfBinding(String cxfBinding) {
    ...
    @Override
    public V1CamelCxfBindingModel setHeaderFilterStrategy(String headerFilterStrategy) {
    ...
    @Override
    public V1CamelCxfBindingModel setLoggingFeatureEnabled(Boolean loggingFeatureEnabled) {
    ...
    @Override
    public V1CamelCxfBindingModel setDefaultOperationName(String defaultOperationName) {
    ...
    @Override
    public V1CamelCxfBindingModel setDefaultOperationNamespace(String defaultOperationNamespace) {
    ...
    @Override
    public V1CamelCxfBindingModel setSynchronous(Boolean synchronous) {
    ...
    @Override
    public V1CamelCxfBindingModel setPublishedEndpointUrl(String publishedEndpointUrl) {
    ...
    @Override
    public V1CamelCxfBindingModel setAllowStreaming(Boolean allowStreaming) {
    ...
    @Override
    public V1CamelCxfBindingModel setSkipFaultLogging(Boolean skipFaultLogging) {
    ...
    @Override
    public V1CamelCxfBindingModel setUsername(String username) {
    ...
    @Override
    public V1CamelCxfBindingModel setPassword(String password) {
