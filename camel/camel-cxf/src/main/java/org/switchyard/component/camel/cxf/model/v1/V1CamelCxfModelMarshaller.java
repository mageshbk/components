...
/**
 * Cxf model marshaller.
 */
public class V1CamelCxfModelMarshaller extends V1BaseCamelMarshaller {

    private static final String BINDING_CXF = BindingModel.BINDING + '.' + V1CamelCxfBindingModel.CXF;
     ...
     */
    public V1CamelCxfModelMarshaller(Descriptor desc) {
        super(desc);
    }
    ...
    public Model read(Configuration config) {
        ...
        if (BINDING_CXF.equals(name)) {
            return new V1CamelCxfBindingModel(config, desc);
        }
