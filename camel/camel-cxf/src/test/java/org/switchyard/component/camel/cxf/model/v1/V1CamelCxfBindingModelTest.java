...
import org.switchyard.component.camel.cxf.model.v1.V1CamelCxfBindingModel;

/**
 * Test of cxf binding model.
 */
public class V1CamelCxfBindingModelTest extends V1BaseCamelServiceBindingModelTest<V1CamelCxfBindingModel, CxfEndpoint> {

    private static final String CAMEL_XML = "/v1/switchyard-cxf-binding.xml";
    ...
    public V1CamelCxfBindingModelTest() throws ParseException {
        super(CxfEndpoint.class, CAMEL_XML);
    }

    @Override
    protected void createModelAssertions(V1CamelCxfBindingModel model) {
    ...
    @Override
    protected V1CamelCxfBindingModel createTestModel() {
        V1CamelCxfBindingModel abm = new V1CamelCxfBindingModel(CamelCxfNamespace.V_2_0.uri());
