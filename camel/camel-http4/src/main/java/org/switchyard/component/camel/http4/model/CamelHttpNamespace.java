...
/**
 * A Camel Http config model namespace.
 */
public enum CamelHttpNamespace implements Namespace {
    ...
    /**
     * Constructs a new CamelHttpNamespace with the specified version.
     * @param version the specified version, or null to discover the default
     */
    CamelHttpNamespace(String version) {
    ...
    /**
     * Gets the CamelHttpNamespace for the specified uri, or null if no matching uris are found.
     * @param uri the uri
     * @return the CamelHttpNamespace
     */
    public static CamelHttpNamespace fromUri(String uri) {
        return Util.fromUri(CamelHttpNamespace.class, uri);
    }
    ...
    private static final class Util extends Namespace.Util {
        ...
        private static final Descriptor DESCRIPTOR = new Descriptor(CamelHttpNamespace.class);
        private Util(String version) {
            super(DESCRIPTOR, "urn:switchyard-component-camel-http4:config", version);
        }
    }
}
