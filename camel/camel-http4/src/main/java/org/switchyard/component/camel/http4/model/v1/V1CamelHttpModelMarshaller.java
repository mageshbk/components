...
/**
 * Http model marshaller.
 */
public class V1CamelHttpModelMarshaller extends V1BaseCamelMarshaller {

    private static final String BINDING_HTTP = BindingModel.BINDING + '.' + V1CamelHttpBindingModel.HTTP;
     ...
     */
    public V1CamelHttpModelMarshaller(Descriptor desc) {
        super(desc);
    }
    ...
    public Model read(Configuration config) {
        ...
        if (BINDING_HTTP.equals(name)) {
            return new V1CamelHttpBindingModel(config, desc);
        }
